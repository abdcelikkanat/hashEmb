...
output_path="./embeddings/{}_1ego_dim={}_deneme3x10.embedding".format(filename, dim)
N=500
L=10
...
srp = SimHashSRP(dim=dim, vocab_size=g.number_of_nodes(), hash_function=_crc32_function, hash_method="random-normal") #orthogonal
